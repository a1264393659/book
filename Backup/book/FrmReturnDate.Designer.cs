namespace book
{
    partial class FrmReturnDate
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmReturnDate));
            ...
            this.label2.Text = "退货期限即为顾客能退货的时间限制，超过这个时间顾客\r\n就不能在退货了，当设置退货期限为0时表示不能退货。";
            // 
            // panel1
            // 
            ...
            "49",
            "50"});
            this.comboBox2.Location = new System.Drawing.Point(187, 129);
            ...
            this.Name = "FrmReturnDate";
            this.Text = "商品退货期限设置";
            this.Load += new System.EventHandler(this.FrmReturnDate_Load);
